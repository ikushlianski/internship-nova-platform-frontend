...
export const handlers = [
    ...
    http.put('/classes/:id', async ({ params, request }) => {
        try {
            ...
            classes = classes.map(classItem => classItem.id === Number(id) ? updatedClass : classItem) 
    ...
    http.put('/spectators/:id', async ({ params, request }) => {
        try {
            ...
            spectators = spectators.map(spectator => spectator.id === Number(id) ? updatedSpectator : spectator) 
