...
export default function ImportanceSection() {
  ...
  return (
    <section className="flex flex-col gap-10 items-center">
      <h2 className="font-semibold text-5xl relative inline-block before:absolute before:left-[-15px] before:right-[-15px] before:bottom-[-5px] before:h-[15px] before:bg-[#C3E6FF] before:rounded-full before:-z-10">
        {t('title')}
      </h2>
