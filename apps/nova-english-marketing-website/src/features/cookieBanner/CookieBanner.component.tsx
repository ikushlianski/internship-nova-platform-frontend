      ...
      <div className="fixed top-0 left-0 w-full h-full backdrop-blur-sm bg-black bg-opacity-30 flex items-center justify-center">
        <div className="bg-white-foreground w-[400px] min-h-64 p-5 rounded-lg">
          ...
          <p>
            ...
            browsing experience in our website, to show you personalized content
            and targeted ads, to analyze our website traffic, ant to understand
            where out visitors are comming from.
          </p>
          <div className="mt-2 text-lg grid grid-cols-2">
            <div>
              <input
                type="checkbox"
                name="first"
              ...
              />
              <label htmlFor="first"> Only necessary</label>
              <br />
              <input type="checkbox" name="second" defaultChecked />
              <label htmlFor="second"> Performance</label>
            </div>
            <div>
              {" "}
              <input type="checkbox" name="third" defaultChecked />
              <label htmlFor="third"> Targeting</label>
              <br />
              <input type="checkbox" name="fourth" defaultChecked />
              <label htmlFor="fourth"> Functionality</label>
            </div>
          </div>
          <div className="flex justify-around mt-3 font-bold pr-4">
            <button
