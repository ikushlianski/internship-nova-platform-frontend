...
*/}}
{{- define "nova-front.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nova-front.fullname" .) .Values.serviceAccount.name }}
{{- else }}
