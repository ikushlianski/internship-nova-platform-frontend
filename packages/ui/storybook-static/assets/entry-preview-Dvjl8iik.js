import { R as a, r as i } from './index-uubelm5h.js';
import { u as l, r as E } from './react-18-CpPJSmEb.js';
...
var g = {};
_(g, { mount: () => M, parameters: () => O, render: () => w, renderToCanvas: () => D });
var w = (r, e) => {
...
async function D(
  { storyContext: r, unboundStoryFn: e, showMain: t, showException: n, forceRemount: u },
  o,
) {
  var m, c;
  let p = a.createElement(b, { showMain: t, showException: n }, a.createElement(e, { ...r })),
  ...
  return (
    ...
    await E(
      h,
      o,
      (c = (m = r == null ? void 0 : r.parameters) == null ? void 0 : m.react) == null
        ? void 0
        : c.rootOptions,
    ),
    () => l(o)
...
var M = (r) => async (e) => (
    e != null && (r.originalStoryFn = () => e), await r.renderToCanvas(), r.canvas
  ),
  O = { renderer: 'react' };
