var d = Object.create,
  ...
  P = (e, r, i, u) => {
    if ((r && typeof r == 'object') || typeof r == 'function')
      for (let a of A(r))
        !m.call(e, a) &&
          a !== i &&
          g(e, a, { get: () => r[a], enumerable: !(u = j(r, a)) || u.enumerable });
    return e;
  },
  S = (e, r, i) => (
    (i = e != null ? d(h(e)) : {}),
    P(!e || !e.__esModule ? g(i, 'default', { value: e, enumerable: !0 }) : i, e)
  ),
  U = x((e) => {
            ...
            switch (p.slice(8, -1)) {
              ...
              case 'Array':
                ...
                for (l = 0; l < t.length; l++)
                  if ((l in t || l in n) && (l in t != l in n || !f(t[l], n[l], o))) return !1;
                return !0;
              case 'Object':
                return f(i(t), i(n), o);
              default:
  ...
  q = (e, r) => {
    ...
    if (v([i, u, a, c]) > 1)
      throw new Error(`Invalid conditional test ${JSON.stringify({ exists: i, eq: u, neq: a })}`);
  ...
  E = (e, r, i) => {
    ...
    if (v([u, a]) !== 1)
      throw new Error(`Invalid conditional value ${JSON.stringify({ arg: u, global: a })}`);
    let c = u ? r[u] : i[a];
    return q(e.if, c);
  },
  I = (e) =>
