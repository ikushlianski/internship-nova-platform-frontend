...
var O = {
  ...
  $ = {};
function p(e, t, r) {
  (this.props = e), (this.context = t), (this.refs = $), (this.updater = r || O);
}
        ...
        : u != null &&
          (g(u) &&
            (u = J(
              u,
              r +
                (!u.key || (s && s.key === u.key) ? '' : ('' + u.key).replace(j, '$&/') + '/') +
                e,
            )),
          t.push(u)),
      1
...
var l = { current: null },
  h = { transition: null },
  X = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: S };
function T() {
...
o.isValidElement = g;
o.lazy = function (e) {
  return { $$typeof: G, _payload: { _status: -1, _result: e }, _init: Q };
};
o.memo = function (e, t) {
