import { c as Ae, g as fn } from './index-uubelm5h.js';
var Tn = Object.create,
  ...
  Jn = (r, t, n, o) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of hn(t))
        !bn.call(r, i) &&
          i !== n &&
          Ye(r, i, { get: () => t[i], enumerable: !(o = vn(t, i)) || o.enumerable });
    return r;
  },
  It = (r, t, n) => (
    (n = r != null ? Tn(gn(r)) : {}), Jn(Ye(n, 'default', { value: r, enumerable: !0 }), r)
  ),
  Rt = f((r, t) => {
  ...
  ge = f((r, t) => {
    ...
    function y(m) {
      return m == null ? (m === void 0 ? l : p) : u && u in Object(m) ? o(m) : i(m);
    }
  ...
  $t = f((r, t) => {
    ...
    function i(p, l) {
      ...
      return (
        (l = l ?? n),
        !!l && (u == 'number' || (u != 'symbol' && o.test(p))) && p > -1 && p % 1 == 0 && p < l
      );
    }
      ...
      for (var j in h)
        (x || m.call(h, j)) &&
          !(
            ...
            (j == 'length' ||
              (_ && (j == 'offset' || j == 'parent')) ||
              (L && (j == 'buffer' || j == 'byteLength' || j == 'byteOffset')) ||
              l(j, A))
          ) &&
          P.push(j);
      return P;
  ...
  aa = f((r, t) => {
    ...
    function i(p, l) {
      var u = this.__data__;
      return (this.size += this.has(p) ? 0 : 1), (u[p] = n && l === void 0 ? o : l), this;
    }
  ...
  ya = f((r, t) => {
    ...
    function l(u, y) {
      ...
      if (m instanceof n) {
        var T = m.__data__;
        if (!o || T.length < p - 1) return T.push([u, y]), (this.size = ++m.size), this;
  ...
  Ta = f((r, t) => {
    function n(o, i) {
      for (var p = -1, l = o == null ? 0 : o.length; ++p < l; ) if (i(o[p], p, o)) return !0;
      return !1;
    }
  ...
  Ra = f((r, t) => {
    ...
    function L(R, P, A, j, D, I) {
      ...
      if (S && !K)
        return I || (I = new n()), V || m(R) ? o(R, P, A, j, D, I) : i(R, P, k, A, j, D, I);
      if (!(A & T)) {
  ...
  et = f((r, t) => {
    ...
    function l(u, y) {
      if (n(u)) return !1;
      var m = typeof u;
      return m == 'number' || m == 'symbol' || m == 'boolean' || u == null || o(u)
        ? !0
  ...
  Va = f((r, t) => {
    ...
    function i(p, l) {
      if (typeof p != 'function' || (l != null && typeof l != 'function')) throw new TypeError(o);
      var u = a(function () {
        var y = arguments,
  ...
  Ka = f((r, t) => {
    function n(o, i) {
      for (var p = -1, l = o == null ? 0 : o.length, u = Array(l); ++p < l; ) u[p] = i(o[p], p, o);
      return u;
    }
  ...
  Ga = f((r, t) => {
    ...
    function y(m, T, h) {
      ...
      return w || ++x != g
        ? w
        : ((g = m == null ? 0 : m.length), !!g && l(g) && p(_, g) && (i(m) || o(m)));
    }
    ...
    (function (n, o) {
      typeof r == 'object' && typeof t < 'u'
        ...
        : typeof define == 'function' && define.amd
          ? define(['exports'], o)
          : ((n = typeof globalThis < 'u' ? globalThis : n || self), o((n.jtpp = {})));
    })(r, function (n) {
      function o(e) {
      ...
      function L(e) {
        var s, c;
        return (c = (s = _.exec(e)) === null || s === void 0 ? void 0 : s[0]) !== null &&
          c !== void 0
          ? c
          : null;
      }
      ...
      let A = a((e) => {
        ...
        j = a((e) => (e.length > 0 ? null : { type: 'EOF', text: '' }), 'eofRule'),
        D = a((e) => {
          let s = L(e);
      ...
      function Y(e) {
        ...
        if (e.type === 'JsdocTypeVariadic') {
          if (((s = e.element) === null || s === void 0 ? void 0 : s.type) === 'JsdocTypeName')
            return e;
          throw new m(e);
        }
        if (e.type !== 'JsdocTypeNumber' && e.type !== 'JsdocTypeName') throw new m(e);
        return e;
      }
      ...
      let oe = class {
        constructor(s, c, d) {
          (this.grammar = s),
            typeof c == 'string' ? (this._lexer = k.create(c)) : (this._lexer = c),
            (this.baseParser = d);
        }
        get lexer() {
          return this._lexer;
        ...
        consume(s) {
          return (
            Array.isArray(s) || (s = [s]),
            s.includes(this.lexer.current.type) ? ((this._lexer = this.lexer.advance()), !0) : !1
          );
        }
        acceptLexerState(s) {
          this._lexer = s.lexer;
        ...
        return (c == null && d === '?' && !Ke(v)) || (c != null && d === '?')
          ? (e.consume('?'),
            c == null
              ...
              : { type: 'JsdocTypeNullable', element: N(c), meta: { position: 'suffix' } })
          : null;
      }, 'nullableParslet');
      function F(e) {
        let s = a((c, d, v) => {
      ...
      let xe = F({
          ...
          parseInfix: a(
            (e, s) => (
              e.consume('='),
              { type: 'JsdocTypeOptional', element: N(s), meta: { position: 'suffix' } }
            ),
            'parseInfix',
          ),
        }),
        ...
        zr = F({
          ...
          accept: a(
            (e, s) => (e === '?' && Ke(s)) || e === 'null' || e === 'undefined' || e === '*',
            'accept',
          ),
          parsePrefix: a((e) => {
        ...
        Wr = F({
          ...
          parseInfix: a(
            (e, s) => (
              e.consume('!'),
              { type: 'JsdocTypeNotNullable', element: N(s), meta: { position: 'suffix' } }
            ),
            'parseInfix',
          ),
        });
      function dt({ allowTrailingComma: e }) {
        return F({
          ...
          parseInfix: a((s, c) => {
            ...
            while (s.consume(','));
            if (d.length > 0 && d.slice(0, -1).some((v) => v.type === 'JsdocTypeVariadic'))
      ...
      let Hr = F({
        ...
        Me = [Ce, xe, we, Yr, zr, Wr, dt({ allowTrailingComma: !0 }), Hr, Xr, xe];
      function le({ allowSquareBracketsOnAnyType: e, allowJsdocNamePaths: s, pathGrammar: c }) {
        return a(function (d, v, b) {
          ...
          switch (z.type) {
            case 'JsdocTypeName':
              me = { type: 'JsdocTypeProperty', value: z.value, meta: { quote: void 0 } };
              break;
            ...
            case 'JsdocTypeStringValue':
              me = { type: 'JsdocTypeProperty', value: z.value, meta: { quote: z.meta.quote } };
              break;
          ...
          return { type: 'JsdocTypeNamePath', left: N(b), right: me, pathType: $ };
        }, 'namePathParslet');
      }
      ...
      function W({ allowedAdditionalTokens: e }) {
        return F({
          name: 'nameParslet',
          accept: a(
            (s) => s === 'Identifier' || s === 'this' || s === 'new' || e.includes(s),
            'accept',
          ),
          parsePrefix: a((s) => {
        ...
        return F({
          ...
          parsePrefix: a((c) => {
            ...
            if (c.consume('StringValue'))
              ...
              let $ = '',
                q = ['Identifier', '@', '/'];
              for (; q.some((Q) => c.consume(Q)); ) ($ += b.text), (b = c.lexer.current);
              v = {
                type: 'JsdocTypeSpecialNamePath',
                value: $,
                specialType: d,
      ...
      let mt = [
          ...
          ue,
          we,
          le({ allowSquareBracketsOnAnyType: !1, allowJsdocNamePaths: !0, pathGrammar: null }),
        ],
      ...
      function Oe({
        ...
        return F({
          ...
          accept: a((v, b) => v === 'function' || (d && v === 'new' && b === '('), 'accept'),
          parsePrefix: a((v) => {
            let b = v.consume('new');
            v.consume('function');
          ...
          parsePrefix: a((c) => {
            ...
            if (!c.consume('}')) {
              ...
              for (;;) {
                ...
                c.acceptLexerState(b), O === void 0 && s && (O = c.parseIntermediateType(J.OBJECT));
                let U = !1;
                if (
                  (O.type === 'JsdocTypeNullable' && ((U = !0), (O = O.element)),
        ...
        return F({
          ...
          parseInfix: a((v, b) => {
            ...
            d && b.type === 'JsdocTypeNullable' && ((U = !0), (b = b.element)),
              c && b.type === 'JsdocTypeReadonlyProperty' && (($ = !0), (b = b.element));
            ...
            if (
              ...
              return (
                v.acceptLexerState(q), { type: 'JsdocTypeJsdocObjectField', left: N(b), right: Q }
              );
            }
          }, 'parseInfix'),
        });
        ...
        return F({
          ...
          parseInfix: a((c, d) => {
            let v = !1,
              b = !1;
            if (
              (e && d.type === 'JsdocTypeNullable' && ((v = !0), (d = d.element)),
              s &&
            ...
            return { type: 'JsdocTypeKeyValue', key: d.value, right: O, optional: v, variadic: b };
          }, 'parseInfix'),
        });
      }
      ...
      let ht = [
          ...
          ue,
          ye({ allowedTypes: ['module', 'external', 'event'], pathGrammar: pe }),
          Ne({ allowEnclosingBrackets: !0, allowPostfix: !0 }),
          W({ allowedAdditionalTokens: ['keyof'] }),
          Tt,
          vt,
          le({ allowSquareBracketsOnAnyType: !1, allowJsdocNamePaths: !0, pathGrammar: pe }),
        ],
        Qr = [
          ...ht,
          _e({
        ...
        gt = F({
          ...
          parsePrefix: a(
            (e) => (
              e.consume('typeof'),
              { type: 'JsdocTypeTypeof', element: N(e.parseType(J.KEY_OF_TYPE_OF)) }
            ),
            'parsePrefix',
          ),
        }),
        Zr = [
          W({ allowedAdditionalTokens: ['module', 'keyof', 'event', 'external', 'in'] }),
          Ce,
          xe,
          ue,
          we,
      ...
      let tn = F({
          ...
          parsePrefix: a(
            (e) => (
              e.consume('keyof'),
              { type: 'JsdocTypeKeyof', element: N(e.parseType(J.KEY_OF_TYPE_OF)) }
            ),
            'parsePrefix',
          ),
        }),
        ...
        nn = F({
          ...
          parsePrefix: a(
            (e) => (
              e.consume('readonly'),
              { type: 'JsdocTypeReadonlyProperty', element: e.parseType(J.KEY_VALUE) }
            ),
            'parsePrefix',
          ),
        }),
        ...
        sn = F({
          ...
          parseInfix: a((e, s) => {
            if (s.type !== 'JsdocTypeName')
              throw new m(s, 'A typescript predicate always has to have a name on the left side.');
            return (
              e.consume('is'),
              { type: 'JsdocTypePredicate', left: s, right: N(e.parseIntermediateType(J.INFIX)) }
            );
          }, 'parseInfix'),
        }),
        pn = F({
          ...
          parsePrefix: a((e) => {
            ...
            if (e.consume(':')) {
              ...
              let d = e.baseParser;
              d.acceptLexerState(e),
                (c = { type: 'JsdocTypeMappedType', key: s, right: d.parseType(J.ARRAY_BRACKETS) }),
                e.acceptLexerState(d);
        ...
        cn = [
          nn,
          W({ allowedAdditionalTokens: ['module', 'event', 'keyof', 'event', 'external', 'in'] }),
          Ce,
          xe,
          ue,
          we,
        ...
        ln = [
          ...
          vt,
          an,
          le({ allowSquareBracketsOnAnyType: !0, allowJsdocNamePaths: !1, pathGrammar: pe }),
          on,
          sn,
      ...
      function Ge() {
        return {
          ...
          JsdocTypeKeyof: a((e, s) => `keyof ${s(e.element)}`, 'JsdocTypeKeyof'),
          ...
          JsdocTypeTuple: a((e, s) => `[${e.elements.map(s).join(', ')}]`, 'JsdocTypeTuple'),
          JsdocTypeVariadic: a(
            (e, s) =>
              e.meta.position === void 0 ? '...' : de(e.meta.position, s(e.element), '...'),
            'JsdocTypeVariadic',
          ),
          ...
          JsdocTypeStringValue: a((e) => H(e.value, e.meta.quote), 'JsdocTypeStringValue'),
          ...
          JsdocTypeGeneric: a((e, s) => {
            if (e.meta.brackets === 'square') {
              ...
              return c.type === 'JsdocTypeUnion' || c.type === 'JsdocTypeIntersection'
                ? `(${d})[]`
                : `${d}[]`;
            } else return `${s(e.left)}${e.meta.dot ? '.' : ''}<${e.elements.map(s).join(', ')}>`;
          }, 'JsdocTypeGeneric'),
          JsdocTypeImport: a((e, s) => `import(${s(e.element)})`, 'JsdocTypeImport'),
          JsdocTypeObjectField: a((e, s) => {
            let c = '';
            return (
              e.readonly && (c += 'readonly '),
              typeof e.key == 'string' ? (c += H(e.key, e.meta.quote)) : (c += s(e.key)),
              e.optional && (c += '?'),
          ...
          JsdocTypeTypeof: a((e, s) => `typeof ${s(e.element)}`, 'JsdocTypeTypeof'),
          JsdocTypeUndefined: a(() => 'undefined', 'JsdocTypeUndefined'),
          JsdocTypeUnion: a((e, s) => e.elements.map(s).join(' | '), 'JsdocTypeUnion'),
          JsdocTypeUnknown: a(() => '?', 'JsdocTypeUnknown'),
          JsdocTypeIntersection: a(
            (e, s) => e.elements.map(s).join(' & '),
            'JsdocTypeIntersection',
          ),
          JsdocTypeProperty: a((e) => H(e.value, e.meta.quote), 'JsdocTypeProperty'),
          JsdocTypePredicate: a((e, s) => `${s(e.left)} is ${s(e.right)}`, 'JsdocTypePredicate'),
          JsdocTypeIndexSignature: a(
            (e, s) => `[${e.key}: ${s(e.right)}]`,
            'JsdocTypeIndexSignature',
          ),
          JsdocTypeMappedType: a((e, s) => `[${e.key} in ${s(e.right)}]`, 'JsdocTypeMappedType'),
        };
      }
      a(Ge, 'stringifyRules');
      let un = Ge();
      ...
      let dn = {
        ...
        JsdocTypeStringValue: a((e) => X(H(e.value, e.meta.quote)), 'JsdocTypeStringValue'),
        ...
        JsdocTypeName: a(
          (e) => (e.value !== 'function' ? X(e.value) : { type: 'FunctionType', params: [] }),
          'JsdocTypeName',
        ),
        ...
        JsdocTypeUnion: a(
          (e, s) => ({ type: 'TypeUnion', elements: e.elements.map((c) => s(c)) }),
          'JsdocTypeUnion',
        ),
        JsdocTypeKeyValue: a(
          (e, s) => ({
        ...
        JsdocTypeNamePath: a((e, s) => {
          ...
          let v = e.pathType === 'inner' ? '~' : e.pathType === 'instance' ? '#' : '.';
          return X(`${c.name}${v}${d}`);
        }, 'JsdocTypeNamePath'),
        JsdocTypeSymbol: a((e) => {
          let s = '',
          ...
          return (
            (c == null ? void 0 : c.type) === 'JsdocTypeVariadic' &&
              (c.meta.position === 'prefix' ? (s = '...') : (d = !0), (c = c.element)),
            (c == null ? void 0 : c.type) === 'JsdocTypeName'
              ? (s += c.value)
              : (c == null ? void 0 : c.type) === 'JsdocTypeNumber' && (s += c.value.toString()),
            d && (s += '...'),
            X(`${e.value}(${s})`)
          );
        }, 'JsdocTypeSymbol'),
        JsdocTypeParenthesis: a((e, s) => s(N(e.element)), 'JsdocTypeParenthesis'),
      ...
      let mn = {
        ...
        JsdocTypeName: a((e) => ({ type: 'NAME', name: e.value }), 'JsdocTypeName'),
        JsdocTypeTypeof: a(
        ...
        JsdocTypeKeyof: a((e, s) => ({ type: 'KEY_QUERY', value: s(e.element) }), 'JsdocTypeKeyof'),
        JsdocTypeImport: a(
          (e) => ({
            type: 'IMPORT',
            path: {
        ...
        JsdocTypeFunction: a((e, s) => {
            ...
            d = {
              ...
              params: c.params.map((v) => {
                if (v.type === 'JsdocTypeKeyValue') {
                  ...
                  return { type: 'NAMED_PARAMETER', name: v.key, typeName: s(v.right) };
                } else return s(v);
              }),
              new: null,
              returns: null,
          ...
          return (
            c.this !== void 0 ? (d.this = s(c.this)) : e.arrow || (d.this = null),
            c.new !== void 0 && (d.new = s(c.new)),
        ...
        JsdocTypeSpecialNamePath: a((e) => {
          ...
          return {
            type: 'MODULE',
            value: { type: 'FILE_PATH', quoteStyle: te(e.meta.quote), path: e.value },
          };
        }, 'JsdocTypeSpecialNamePath'),
        JsdocTypeNamePath: a((e, s) => {
          let c = !1,
        ...
        JsdocTypeUnion: a((e, s) => Ee('UNION', e.elements.map(s)), 'JsdocTypeUnion'),
        JsdocTypeParenthesis: a(
        ...
        JsdocTypeStringValue: a(
          (e) => ({ type: 'STRING_VALUE', quoteStyle: te(e.meta.quote), string: e.value }),
      ...
      function Nt() {
        return {
          JsdocTypeIntersection: a(
            (e, s) => ({ type: 'JsdocTypeIntersection', elements: e.elements.map(s) }),
            'JsdocTypeIntersection',
          ),
          JsdocTypeGeneric: a(
            (e, s) => ({
          ...
          JsdocTypeJsdocObjectField: a(
            (e, s) => ({ type: 'JsdocTypeJsdocObjectField', left: s(e.left), right: s(e.right) }),
            'JsdocTypeJsdocObjectField',
          ),
          JsdocTypeKeyValue: a(
            (e, s) => ({
          ...
          JsdocTypeFunction: a((e, s) => {
            ...
            return e.returnType !== void 0 && (c.returnType = s(e.returnType)), c;
          }, 'JsdocTypeFunction'),
          JsdocTypeKeyof: a(
          ...
          JsdocTypePredicate: a(
            (e, s) => ({ type: 'JsdocTypePredicate', left: s(e.left), right: s(e.right) }),
            'JsdocTypePredicate',
          ),
          JsdocTypeIndexSignature: a(
            (e, s) => ({ type: 'JsdocTypeIndexSignature', key: e.key, right: s(e.right) }),
            'JsdocTypeIndexSignature',
          ),
          JsdocTypeMappedType: a(
            (e, s) => ({ type: 'JsdocTypeMappedType', key: e.key, right: s(e.right) }),
            'JsdocTypeMappedType',
          ),
        };
      }
...
const { UnknownArgTypesError: ro } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var Qt = /^['"]|['"]$/g,
        ...
        return (
          (i = r.elements) != null && i.every((m) => m.name === 'literal')
            ? (y = {
                ...o,
                name: 'enum',
                value: (p = r.elements) == null ? void 0 : p.map((m) => Zt(m.value)),
              })
            : (y = { ...o, name: t, value: (l = r.elements) == null ? void 0 : l.map(ve) }),
          y
        );
      case 'intersection':
        return { ...o, name: t, value: (u = r.elements) == null ? void 0 : u.map(ve) };
      default:
        return { ...o, name: 'other', value: t };
    }
  }, 'convert');
const { UnknownArgTypesError: so } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
    ...
    switch ((typeof n < 'u' && (o.raw = n), r.name)) {
      ...
      case 'union':
        return (i = r.elements) != null && i.every(io)
          ? { ...o, name: 'enum', value: (p = r.elements) == null ? void 0 : p.map(po) }
          : { ...o, name: t, value: (l = r.elements) == null ? void 0 : l.map(he) };
      case 'intersection':
        return { ...o, name: t, value: (u = r.elements) == null ? void 0 : u.map(he) };
      default:
        return { ...o, name: 'other', value: t };
    }
  }, 'convert'),
...
function pr({ fence: r = '```' } = {}) {
  ...
  return a(function (o) {
    let i = [[]],
      p = !1;
    for (let l of o)
      To.test(l.tokens.description) && !p ? i.push([l]) : i[i.length - 1].push(l),
  ...
  return a(function (i) {
    ...
    if (
      (l.delimiter === '' &&
        ...
        !p.startsWith(t.end) &&
        ((l.delimiter = t.delim), (p = p.slice(t.delim.length)), ([l.postDelimiter, p] = se(p))),
      u)
    ) {
      let y = p.trimRight();
      (l.end = p.slice(y.length - t.end.length)), (p = y.slice(0, -t.end.length));
    }
    if (((l.description = p), n.push({ number: o, source: i, tokens: l }), o++, u)) {
      let y = n.slice();
      return (n = null), y;
    }
    return null;
  ...
  return (n) => {
    ...
    for (let [u, [y, m]] of i.entries())
      (y.type = m),
        ...
        p.push(y.type);
    return (
      (p[0] = p[0].slice(1)), (p[p.length - 1] = p[p.length - 1].slice(0, -1)), (n.type = t(p)), n
    );
  };
}
a(dr, 'typeTokenizer');
...
a(wr, 'parse');
var xo = { tags: ['param', 'arg', 'argument', 'returns', 'ignore', 'deprecated'] },
  wo = a((r, t = xo) => {
    ...
    return o.ignore
      ...
      : { includesJsDoc: !0, ignore: !1, description: n.description.trim(), extractedTags: o };
  }, 'parseJsDoc');
function Pr(r, t) {
    ...
    if (!(t !== void 0 && !t.includes(o.tag)))
      if (o.tag === 'ignore') {
        ...
        switch (o.tag) {
          ...
          case 'argument': {
            let i = Nr(o);
            i != null && (n.params == null && (n.params = []), n.params.push(i));
            break;
          }
          case 'deprecated': {
            let i = _r(o);
...
function Er({ name: r, raw: t, elements: n }) {
  return n != null ? C(n.map(lt).join(' | ')) : t != null ? C(t.replace(/^\|\s*/, '')) : C(r);
}
a(Er, 'generateUnion');
...
var No = a((r, t) => {
  ...
  return { name: r, type: Ur(t), required: o, description: n, defaultValue: Vr(t) };
}, 'createTsPropDef');
function $r(r) {
...
function ut(r, t, n) {
  ...
  return { name: r, type: $r(t), required: i, description: o, defaultValue: Cr(p, t) };
}
    ...
    let p = {
      ...
      params:
        (n = i == null ? void 0 : i.params) == null
          ? void 0
          : n.map((l) => ({ name: l.getPrettyName(), description: l.description })),
    };
...
function yt(r, t, n, o) {
  ...
  return i.includesJsDoc && i.ignore
    ? null
    : { propDef: o(r, t, i), jsDocTags: i.extractedTags, docgenInfo: t, typeSystem: n };
}
a(yt, 'extractProp');
function Io(r) {
  return r != null ? rr(r) : '';
...
var Ps = a((r) => {
  ...
  Lo = ((r) => ((r.AUTO = 'auto'), (r.CODE = 'code'), (r.DYNAMIC = 'dynamic'), r))(Lo || {}),
...
function ns(r) {
  return r == null ? (r === void 0 ? rs : ts) : At && At in Object(r) ? Zo(r) : es(r);
}
var as = ns;
function os(r, t) {
  return function (n) {
