...
function E(e, t, o, l) {
  let i = [];
  o.forEach((n, r) => {
    let f = l && n.position === 'center' ? it(e, t, n) : et(e, t, n, i[r - 1], l);
    i[r] = f;
  });
}
function lt(e, t, o, l) {
...
function rt(e, { margin: t, width: o, height: l, top: i, left: n, bottom: r, right: f }) {
...
function st(e, { border: t, width: o, height: l, top: i, left: n, bottom: r, right: f }) {
...
function ht(e, { padding: t, border: o, width: l, height: i, top: n, left: r }) {
  let f = l - o.left - o.right - t.left - t.right,
    a = i - t.top - t.bottom - o.top - o.bottom;
  return (
