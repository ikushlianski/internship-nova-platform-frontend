      ...
      Zt = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let a of et(t))
            !qt.call(e, a) &&
              a !== r &&
              pe(e, a, { get: () => t[a], enumerable: !(n = Yt(t, a)) || n.enumerable });
        return e;
      },
      Kt = (e, t, r) => (
        (r = e != null ? $t(Jt(e)) : {}),
        Zt(t || !e || !e.__esModule ? pe(r, 'default', { value: e, enumerable: !0 }) : r, e)
      ),
      Qt = fe({
    ...
    var ue = ({ data: e }) => {
        ...
        if (Array.isArray(r)) {
          let n = t.arrayMaxProperties,
            a = r.slice(0, n).map((s, l) => o.createElement(z, { key: l, object: s }));
    ...
    var br = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Or = ({ data: e, columns: t }) => {
        let r = S('TableInspector'),
          [{ sorted: n, sortIndexColumn: a, sortColumn: i, sortAscending: s }, l] = U({
            sorted: !1,
            sortIndexColumn: !1,
            sortColumn: void 0,
            sortAscending: !1,
      ...
      st = Se(({ children: e, className: t }, r) =>
        o.createElement(Me, { ref: r, horizontal: !0, vertical: !0, className: t }, e),
      );
    st.displayName = 'UnstyledWrapped';
    var Mr = B(st)({ margin: 0, padding: '10px 5px 20px' }),
      Pr = ze(({ theme: e, ...t }) =>
        o.createElement(xr, { theme: e.addonActionsTheme || 'chromeLight', table: !1, ...t }),
      ),
      Br = ({ actions: e, onClear: t }) => {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(Ie, { actionItems: [{ title: 'Clear', onClick: t }] }),
          )
        );
      },
      Fr = 'actions',
          ...
          super(e),
            ...
            (this.addAction = (t) => {
              this.setState((r) => {
                ...
                return (
                  a && Hr(a.data, t.data) ? a.count++ : ((t.count = 1), n.push(t)),
